...
dial_config.augend:register_group {
  default = {
...
vim.cmd [[
  ...
  autocmd FileType typescript,javascript lua vim.api.nvim_buf_set_keymap(0, "n", "<C-a>", require("dial.map")inc._normal("typescript"), {noremap = true})
]]
